...
class TestFailedTests:
    def test_get_failed_tests(self, tmpdir) -> None:
        ...
        rd = RunData(1, 1)
        case_result1 = self.__create_error_result(test1, rd, "NOK")
        case_result2 = self.__create_succesfuls_result(test2, rd, "OK")
        case_result3 = self.__create_error_result(test3, rd, "ERROR")
