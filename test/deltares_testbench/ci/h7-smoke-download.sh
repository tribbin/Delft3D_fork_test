...
docker run --rm \
           ...
           "$container" python3 TestBench.py --filter "testcase=e02_f014_c001,e109_f01_c010,e112_f01_c11" --reference --skip-run --skip-post-processing --config configs/apptainer/dimr/dimr_smoke_test_lnx64.xml --log-level INFO --parallel
