...
3. run_native_h7.sh (Copy from https://github.com/Deltares/Delft3D/tree/main/src/scripts_lgpl/singularity) file to run on the Deltares h7 cluster. (For dwaq testcases, the path to dwaq libraries should be added to the script.)
4. submit_singularity_h7.sh (Copy from https://github.com/Deltares/Delft3D/tree/main/src/scripts_lgpl/singularity) file to run an Apptainer on the Deltares h7 cluster. (For dwaq testcases, the path to dwaq libraries should be added to the script.)
