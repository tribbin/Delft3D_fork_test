...
function(get_ifort_version)
    if (${CMAKE_Fortran_COMPILER_VERSION} MATCHES "2021\.(1|2|3|4)[\.0-9]*")
        set(ifort_version 21 PARENT_SCOPE)
    elseif (${CMAKE_Fortran_COMPILER_VERSION} MATCHES "2021\.(5|6|7)[\.0-9]*")
        set(ifort_version 22 PARENT_SCOPE)
    elseif (${CMAKE_Fortran_COMPILER_VERSION} MATCHES "2021\.(8|9|10)\.[0-9]\.2023[0-9][0-9][0-9][0-9]")
        set(ifort_version 23 PARENT_SCOPE)
    elseif (${CMAKE_Fortran_COMPILER_VERSION} MATCHES "(2021\.0\.0\.20240222|2024\.[0-9]\.[0-9])")
        set(ifort_version 24 PARENT_SCOPE)
    else()
        message(FATAL_ERROR "ifort version ${CMAKE_Fortran_COMPILER_VERSION} is not recognized.")
    endif()
