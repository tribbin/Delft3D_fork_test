...
if (UNIX)
    ...
    set(automatic_local_variable_storage_flag    "-auto")
    set(extend_source132_flag                    "SHELL:-extend-source 132")
    set(real_size_64_flag                        "-r8")

    set(file_preprocessor_flag                   "-fpp")
    set(check_bounds_flag                        "SHELL:-check bounds")
    set(check_nobounds_flag                      "SHELL:-check nobounds")
    set(check_pointers_flag                      "SHELL:-check pointers")
    set(check_nopointers_flag                    "SHELL:-check nopointers")
    set(check_uninit_flag                        "SHELL:-check uninit")
    set(check_stack_flag                         "SHELL:-check stack")
    set(openmp_flag                              "-qopenmp")     # To disable: set to -qopenmp-stubs
    set(generate_reentrancy_threaded_flag        "SHELL:-reentrancy threaded")
    set(floating_point_exception_flag            "-fpe0")
    set(traceback_flag                           "-traceback")
    set(heap_arrays_100_flag                     "SHELL:-heap-arrays 100")
