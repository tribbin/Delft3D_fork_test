...
!     
!          FUNCTION           :  Write TABLE_R4 group to NEFIS file
!     
...
!          NO_OUTP      INT            I       number of rows in table r4
!          R4_PID       CHA*10 NO_OUTP I       process identification
!          R4_IID       CHA*10 NO_OUTP I       item identification
!          R4_NUMB      INT    NO_OUTP I       serial number
!          R4_DOC       CHA*1  NO_OUTP I       documented y/n
!          R4_SEX       INT    NO_OUTP I       segment or exchange
