...
!     
!          FUNCTION           :  Write TABLE_R8 group to NEFIS file
!     
...
!          NO_DSTO      INT            I       number of rows in table R8
!          R8_DID       CHA*10 NO_DSTO I       velocity identification
!          R8_SID       CHA*10 NO_DSTO I       substance identification
!          R8_SCAL      REAL   NO_DSTO I       scale factor
