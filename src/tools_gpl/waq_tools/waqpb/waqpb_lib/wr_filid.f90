...
!     
!          FUNCTION           :  Write File Identification group to NEFIS file
!     
...
!          FFORM   CH*40       1       I       File Format
!          VFFORM  REAL        1       I       Version File Format
!          CONTEN  CH*40       1       I       File contents
!          VERSIO  REAL        1       I       Version number process library
!          SERIAL  INT         1       I       File serial number
!          RUNDAT  CH*20       1       I       Creation date
!          SOURCE  CH*40       1       I       Source data
!          REMARK  CH*40       4       I       Remarks
