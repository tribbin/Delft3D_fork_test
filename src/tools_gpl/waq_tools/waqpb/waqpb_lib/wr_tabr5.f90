...
!     
!          FUNCTION           :  Write TABLE_R5 group to NEFIS file
!     
...
!          NO_OUTF      INT            I       number of rows in table r3
!          R5_PID       CHA*10 NO_OUTF I       process identification
!          R5_IID       CHA*10 NO_OUTF I       item identification
!          R5_NUMB      INT    NO_OUTF I       serial number
!          R5_DOC       CHA*1  NO_OUTF I       documented y/n
...
!     
      INTEGER       NO_OUTF     , LUNREP     , & 
                   IERROR
      INTEGER       DEFFDS
      CHARACTER(len=10)  R5_PID      (NO_OUTF)
      CHARACTER(len=10)  R5_IID      (NO_OUTF)
      INTEGER       R5_NUMB(NO_OUTF)
      CHARACTER(len=1)   R5_DOC (NO_OUTF)
!     
!          Local variables
!     
