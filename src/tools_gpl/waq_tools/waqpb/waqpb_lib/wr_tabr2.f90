...
!     
!          FUNCTION           :  Write TABLE_R2 group to NEFIS file
!     
...
!          NO_CNSB      INT            I       number of rows in table r2
!          R1_CID       CHA*10 NO_CNSB I       configuration identification
!          R1_SID       CHA*10 NO_CNSB I       substance identification
...
!     
      INTEGER       NO_CNSB     , LUNREP     , & 
                   IERROR
      INTEGER       DEFFDS
      CHARACTER(len=10)  R2_CID      (NO_CNSB)
      CHARACTER(len=10)  R2_SID      (NO_CNSB)
!     
!          Local variables
!     
