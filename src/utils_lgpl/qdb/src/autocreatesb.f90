...
!
!-------------------------------------------------------------------------------
subroutine autocreatesb(fds1, fds2, fds3, grp, fout, mlim, nlim)
   !
   !=============================================================
   ! DEFINE VARIABLES
   !-------------------------------------------------------------
   ...
   integer(2), intent(in) :: mlim
   integer(2), intent(in) :: nlim
   !
   ! LOGICAL variables
   !
   ...
   if (ierr == 6004) then
      ...
      !
      call copygroupsb(fds1, fds2, fds3, grpnam, 1, 1, 1, fout, mlim, nlim)
   end if
   !
end subroutine autocreatesb
