...
subroutine read_morphology_output_options(mor_ptr, moroutput, lsedtot, filmor, lundia, error)
    ...
    call prop_get(mor_ptr, 'Output', 'TotalSedTransport'           , moroutput%sxytot)
    ...
    call prop_get(mor_ptr, 'Output', 'Sedconc'                     , moroutput%sedconc)
    ...
    call prop_get(mor_ptr, 'Output', 'SedimentLayerThickness'      , moroutput%dpsed)
    ...
    !
    call prop_get(mor_ptr, 'Output', 'TimeaveragedSedTransport'    , moroutput%sxyavg)
    call prop_get(mor_ptr, 'Output', 'AverageAtEachOutputTime'     , moroutput%cumavg)
    !
    call prop_get(mor_ptr, 'Output', 'CumulativeSubsidenceUplift'  , moroutput%cumsubsupl)
    call prop_get(mor_ptr, 'Output', 'Preload'                     , moroutput%preload)
    call prop_get(mor_ptr, 'Output', 'MorfacMorft'                 , moroutput%morfacft)
    !
