...
!
! Module:             SOWRES (SObek Write RESults)
!
! Module description: After calculating a time step for all modules
!                     mentioned in the application this routine is cal-
!                     led to write results. The routine has been split-
!                     ted in different routines for the different modu-
!                     les to be able to sell sobek stripped.
!
!                     Depending on the user selected scenario and re-
!                     sults the output routines will be called.
!
!-----------------------------------------------------------------------
! Parameters:
...
! 15 lflow             I  Switch to enable flow module
! 16 lkalm             I  -
...
! 17 lsalt             I  Logical indicator for salt computation
!                         = .true.  : with salt computation
!                         = .false. : no salt computation
! 18 lsedt             I  Switch to enable sediment transport module
! 20 iwqin             P  -
!  8 newres            I  true, if a new restart file will be made
!  5 nstep             I  Last time step number in simulation.
!  7 restrt            I  Period of writing restart file (0 = write at
!                         end of run)
!  3 time              I  Actual time level tn+1. in sec.
!  6 wqagst            P  -
!-----------------------------------------------------------------------
! Subprogram calls:
! NAME    DESCRIPTION
! flsdat  FLuSh buffers of DATa file
! flwres  FLow Write RESults
! gtipnt  GeT Integer PoiNTer
! gtlpnt  GeT Logical PoiNTer
! gtrpnt  GeT Real PoiNTer
! kawres  KAlman Write RESults
! motrou  MOrphology TRaject OUtput file(s)
! mowres  MOrphology Write RESults
! sawres  SAlt Write RESults
! sewres  SEdiment Write RESults
...
! History:
! $Log: sowres.pf,v $
! Revision 1.18  1999/03/15  15:01:03  kuipe_j
! IVBDOS
!
! Revision 1.17  1998/06/08  13:15:44  kuipe_j
! time lag hydr controller
!
! Revision 1.16  1997/11/04  14:20:01  kuipe_j
! Retention basin
!
! Revision 1.15  1997/06/17  11:29:25  kuipe_j
! output in history format
!
! Revision 1.14  1997/05/26  07:37:05  kuipe_j
! statistic of iteration improved
!
! Revision 1.13  1997/02/17  10:09:41  kuipe_j
! Lateral Q in m3/s in cont. equation now
!
! Revision 1.12  1997/01/23  08:30:19  kuipe_j
! Make flow module robust
!
! Revision 1.11  1996/12/03  09:03:59  kuipe_j
! Salt restart improved
!
! Revision 1.10  1996/04/12  13:06:15  kuipe_j
! headers, minor changes
!
! Revision 1.9  1996/04/11  08:16:42  kuipe_j
! Kalman module added
!
! Revision 1.8  1996/01/17  14:47:44  kuipe_j
! header update
!
! Revision 1.7  1996/01/16  15:01:58  kuipe_j
! Restart improvements
!
! Revision 1.6  1995/10/18  09:01:10  kuipe_j
! Changes concerning aux. ouput and IVR adjustments
!
! Revision 1.5  1995/09/12  08:11:36  overmar
! - Option "zomerkaden" added
! - Better linearization
! - Pseudo time
! - Iterative matrix solution
!
! Revision 1.4  1995/08/30  12:37:38  kuipe_j
! Triggers + controllers for BOS
!
! Revision 1.3  1995/05/30  09:57:11  hoeks_a
! Minor changes
!
! Revision 1.2  1995/05/30  07:10:06  hoeks_a
! file changed from dos to ux
!
! Revision 1.1  1995/04/13  07:12:31  hoeks_a
! Initial check-in
!
! Revision 1.3  1994/11/28  08:28:48  kuipe_j
! Time and timestep in double precision.
!
! Revision 1.2  1993/11/26  15:10:14  kuipe_j
...
!
!     Workstations: flush true
!
   writim = .true.
!
!     Determine if it is time to write restart info
!
...
!
!     Find pointers of the different file descriptors
!
   if (newres) then
...
!ARS 7786: Zelfde wijze als voor H zijn Q arrays gedefinieerd
!          Let ook op declaraties boven
...
!
!       This call must before IVBDSM as in that routine also
!       maxima are detemined. In FLMINMAX also the time of
...
!ARS 7786 Gebruik routine om ook de
!ARS 7786 qmin en qmax en de bijbehorende tijden te berekenen

!
!       IVBDOS call after wrirst is set and before first is made false.
!
...
!
!     Output of SALT results
!
   if ((lsalt) .and. (ker .ne. fatal)) then
!
!        Fetch pointers of salt arrays
!
      buffer  =    gtrpnt('BUFFER')
      cdcdx   =    gtrpnt('CDCDX' )
      csa     =    gtrpnt('CSA'   )
...
!
!     Output of SEDIMENT results
!
   if ((lsedt) .and. (ker .ne. fatal)) then
!
!        Fetch pointers of sediment arrays
!
      ixpar   = gtrpnt ( 'FLWPAR' )
      g       = sorpar ( rp(ixpar), 1 )
      ixpar   = gtrpnt ( 'SEDPAR' )
...
!
!     Output of MORPHOLOGY results
!
   if ((lmorp) .and. (ker .ne. fatal)) then
!
!        Fetch pointers of morphology arrays
!
      branch  =    gtipnt('BRANCH')
      buffer  =    gtrpnt('BUFFER')
      dissed  =    gtrpnt('DISSED')
...
!
!     Output of GRADED SEDIMENT results
!
...
!
!     Flush results to result file if switch 'writim' is true
!
   if (writim) then
