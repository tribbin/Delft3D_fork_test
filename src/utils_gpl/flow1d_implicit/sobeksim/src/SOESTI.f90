...
!
! Module:             SOESTI (SObek EStuary TIdal calculation)
!
! Module description: This routine iterates one time step of the tidal
!                     period.
!
!                     First a flow step is iterated. If the flow step
!                     has reached convergence optional a salt step is
!                     performed followed by a sediment transport calcu-
!                     lation. The next step is the calculation of the
!                     celereties. The calculated sediment transports and
!                     celereties are aggregated by routine SOSCAG.
!
!-----------------------------------------------------------------------
! Parameters:
...
! soscag  SObek Sediment Celerity AGgregate
!=======================================================================
!
!
!
...
! History:
! $Log: soesti.pf,v $
! Revision 1.17  1999/03/15  15:05:14  kuipe_j
! Improve Froude file
!
! Revision 1.16  1998/06/11  11:47:39  kuipe_j
! Estuary special integrated
!
! Revision 1.15  1997/11/26  14:56:28  kuipe_j
! diffusion zero for free flow
!
! Revision 1.14  1997/05/26  07:36:59  kuipe_j
! statistic of iteration improved
!
! Revision 1.13  1997/01/23  08:30:10  kuipe_j
! Make flow module robust
!
! Revision 1.12  1996/12/04  11:59:28  kuipe_j
! declarations / undefined vars
!
! Revision 1.11  1996/04/12  13:06:03  kuipe_j
! headers, minor changes
!
! Revision 1.10  1996/04/11  08:16:30  kuipe_j
! Kalman module added
!
! Revision 1.9  1995/11/21  11:09:10  kuipe_j
...
!
! Revision 1.8  1995/10/18  09:01:01  kuipe_j
! Changes concerning aux. ouput and IVR adjustments
!
! Revision 1.7  1995/09/29  10:36:37  kuipe_j
! Improvement of autostart and simple weir
!
! Revision 1.6  1995/09/22  10:04:09  kuipe_j
! variable dimensions, new headers
!
! Revision 1.5  1995/09/12  08:11:30  overmar
! - Option "zomerkaden" added
! - Better linearization
! - Pseudo time
! - Iterative matrix solution
!
! Revision 1.4  1995/08/30  12:37:32  kuipe_j
! Triggers + controllers for BOS
!
! Revision 1.3  1995/05/30  09:56:52  hoeks_a
! Minor changes
!
! Revision 1.2  1995/05/30  07:09:46  hoeks_a
! file changed from dos to ux
!
! Revision 1.1  1995/04/13  07:12:11  hoeks_a
! Initial check-in
!
! Revision 1.4  1994/11/28  08:28:36  kuipe_j
! Time and timestep in double precision.

! Revision 1.3  1993/12/13  15:49:53  kuipe_j
! Improved declaration of DSTEP.
! Pointers for Salt module are only set if module is present.
!
! Revision 1.2  1993/11/26  15:09:47  kuipe_j
...
!
      ...
      &ker    )
!
!        Aggregate sediment transports, lateral sediment and
!        water levels.
!
