...
! ----------------------------------------------------------------------
!
!       Funktie : initialiseer voor bereken karakteristieke waterstanden
!                 en eb- en vloedvolumes.
!-----------------------------------------------------------------------
   ...
   lestmorf = .true.
!         Haal de lengte van de getij-periode
   OPEN( 210, FILE = 'estmorf.inp', STATUS = 'OLD',&
   &IOSTAT = iost)
   IF ( iost .NE. 0 ) THEN
      lestmorf = .false.
!            STOP 'Error opening file = estmorf.inp'
      return
   ENDIF
...
!       Funktie : Bereken karakteristieke waterstanden
!                 Bereken eb- en vloedvolumes.
