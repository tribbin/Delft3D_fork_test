...
!
! Module:             GTIPNT (GeT Integer variable PoiNTer)
!
! Module description: Report address of variable in IPool
!
...
!  0 gtipnt            O  Address of integer variable
!  1 pntnam            P  -
!-----------------------------------------------------------------------
! Subprogram calls:
! NAME    DESCRIPTION
...
!
! Revision 1.1  1995/04/13  07:08:42  hoeks_a
! Initial check-in
!
