...
!
!     Close the nefis files, water quality file will be opened
!     by subroutine wqint

900 continue
!
!
!     Output of maxima and minima
!
!     Set pointers
!
...
!ARS07786 Extra pointers ingevoerd en extra parameters in
!         call naar FLMINMAX
...
!
!     Test if water quality has been included in application
!
