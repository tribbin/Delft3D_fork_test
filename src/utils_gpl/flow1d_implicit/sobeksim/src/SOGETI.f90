...
!
! Module:             SOGETI (SObek GET Integer variable)
!
! Module description: Allocate memory and read contents of variable into
!                     memory (integer pool). See chapter 6 of
...
! History:
! $Log: sogeti.pf,v $
! Revision 1.5  1999/03/15  15:19:50  kuipe_j
! tabs removed
!
! Revision 1.4  1995/09/22  10:04:14  kuipe_j
! variable dimensions, new headers
!
! Revision 1.3  1995/05/30  09:56:56  hoeks_a
! Minor changes
!
! Revision 1.2  1995/05/30  07:09:49  hoeks_a
! file changed from dos to ux
!
! Revision 1.1  1995/04/13  07:12:14  hoeks_a
! Initial check-in
!
! Revision 1.2  1993/11/26  15:09:53  kuipe_j
