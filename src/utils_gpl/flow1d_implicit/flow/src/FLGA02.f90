...
!
! Module:             FLGA02 (FLow Get Arguments for structure type 02)
!
! Module description: Unpack the array strpar for an open flume.
!
!-----------------------------------------------------------------------
! Subprogram calls:
! NAME    DESCRIPTION
...
! History:
! $Log: flga02.pf,v $
! Revision 1.2  1998/06/08  12:35:23  kuipe_j
! log added
!
!
!
