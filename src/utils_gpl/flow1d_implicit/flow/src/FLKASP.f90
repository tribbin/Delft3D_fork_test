...
!
! Module:             FLKASP (FLow KAlman Structure correction Parameter)
!
! Module description: Correction on contraction coefficient of general
!                     structure due to uncertain correction parameter.
!
!                     Mu = Mu_cor * Pmu
!                     with:
...
! History:
! $Log: flkasp.pf,v $
! Revision 1.3  1999/03/15  15:50:19  kuipe_j
! tabs removed
!
! Revision 1.2  1996/04/12  13:04:02  kuipe_j
! headers, minor changes
!
! Revision 1.1  1996/04/11  08:23:33  kuipe_j
! Kalman module added
!
!
!***********************************************************************
