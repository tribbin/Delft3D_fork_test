...
! History:
! $Log: gsacel.F,v $
! Revision 1.4  1996/06/07  11:55:35  kuipe_j
! multi  +  fixed layer
!
! Revision 1.3  1996/01/08  13:29:42  kuipe_j
! Multi layer option for under layer added
!
! Revision 1.2  1995/09/27  10:11:46  kuipe_j
! Maintenance
!
!
!***********************************************************************
!
!  Module:     Graded Sediment calculate coefficient A for CELerity
!
...
!
!     Calculate coefficients Aj, Bj, and Cj
!
   do 10 jf=1,nfrac
      if (nlayer .eq. 1) then
         if (depos(igr)) then
...
10 continue
!
!     Calculate sums of Xj * d(Sk)/d(dm) for X=A,B and C.
!
   sum0 = 0.
   sum2 = 0.
   sum3 = 0.
...
20 continue
!
!     Calculate coefficients A0ij,A1ikj,A2ij,A3ij to be transferred
!     to the morphology module.
!
