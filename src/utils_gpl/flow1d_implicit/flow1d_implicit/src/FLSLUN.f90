...
!
! Module:             FLSLUN (FLow structure SLuice with UNderflow gate)
!
! Module description: In subroutine FLSLUN the ABCDE coefficients are
!                     computed for a sluice with underflow gate
!
!-----------------------------------------------------------------------
! Subprogram calls:
! NAME    DESCRIPTION
! flupdo  flow conditions near structure
! flga07  unpacks the array strpar for a sluice with underflow gate
!=======================================================================
!
!***********************************************************************
! CVS log information:
...
! History:
! $Log: flslun.pf,v $
! Revision 1.2  1998/06/08  12:35:50  kuipe_j
! log added
!
!
!
