...
public:
	 ...
	 */
    pidControllerVelocity(string id, string name, double p, double i, double d, double f,
		double settingMin, double settingMax, double settingMaxSpeed,
		int iXIn, int iSPIn, int iFIn, int iYOut, int iIOut, int iDOut, int numSeries);
    pidControllerVelocity(string id, string name, double p, double i, double d, double f,
		double settingMin, double settingMax, double settingMaxSpeed,
		int iXIn, double SPIn, int iFIn, int iYOut, int iIOut, int iDOut, int numSeries);
