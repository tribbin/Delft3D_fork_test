...
contains
    subroutine orien_temperature (n, m, num_rows, num_columns, mnmaxk, &
        ...
        if (n1 > 0 .and. .not. thd_n1) then                                         !If the down position is in the grid and is not an inactive cell
            if ((temper1(n1) < ub_temp) .and. (temper1(n1) > lb_temp)) then    !If salinity is within excepted range
                temp_n1 = temper1(n1)                                                    ! Save temperature of n1
                if (temp_n1 < low_temp) then                                        !If temperature in the down position is lower than lowest temperature encountered in area
        ...
        if (n12 > 0 .and. .not. (thd_n1 .and. thd_n2)) then                       !If the down-left position is in the grid and is not an inactive cell
            if ((temper1(n12) < ub_temp) .and. (temper1(n12) > lb_temp)) then  !If salinity is within excepted range
                temp_n12 = temper1(n12)                                                  ! Save temperature of n12
                if (temp_n12 < low_temp) then                                       !If temperature in the down-left position is lower than lowest temperature encountered in area
        ...
        if (n2 > 0 .and. .not. thd_n2) then                                         !If the left position is in the grid and is not an inactive cell
            if ((temper1(n2) < ub_temp) .and. (temper1(n2) > lb_temp)) then    !If salinity is within excepted range
                temp_n2 = temper1(n2)                                                    ! Save temperature of n2
                if (temp_n2 < low_temp) then                                        !If temperature in the left position is lower than lowest temperature encountered in area
        ...
        if (n23 > 0 .and. .not. (thd_n2 .and. thd_n3)) then                       !If the up-left position is in the grid and is not an inactive cell
            if ((temper1(n23) < ub_temp) .and. (temper1(n23) > lb_temp)) then  !If salinity is within excepted range
                temp_n23 = temper1(n23)                                                  ! Save temperature of n23
                if (temp_n23 < low_temp) then                                       !If temperature in the up-left position is lower than lowest temperature encountered in area
        ...
        if (n3 > 0 .and. .not. thd_n3) then                                         !If the up position is in the grid and is not an inactive cell
            if ((temper1(n3) < ub_temp) .and. (temper1(n3) > lb_temp)) then    !If salinity is within excepted range
                temp_n3 = temper1(n3)                                                    ! Save temperature of n3
                if (temp_n3 < low_temp) then                                        !If temperature in the up position is lower than lowest temperature encountered in area
        ...
        if (n34 > 0 .and. .not. (thd_n3 .and. thd_n4)) then                       !If the up-right position is in the grid and is not an inactive cell
            if ((temper1(n34) < ub_temp) .and. (temper1(n34) > lb_temp)) then  !If salinity is within excepted range
                temp_n34 = temper1(n34)                                                  ! Save temperature of n34
                if (temp_n34 < low_temp) then                                       !If temperature in the up-right position is lower than lowest temperature encountered in area
        ...
        if (n4 > 0 .and. .not. thd_n4) then                                         !If the right position is in the grid and is not an inactive cell
            if ((temper1(n4) < ub_temp) .and. (temper1(n4) > lb_temp)) then    !If salinity is within excepted range
                temp_n4 = temper1(n4)                                                    ! Save temperature of n4
                if (temp_n4 < low_temp) then                                        !If temperature in the right position is lower than lowest temperature encountered in area
        ...
        if (n41 > 0 .and. .not. (thd_n4 .and. thd_n1)) then                       !If the down-right position is in the grid and is not an inactive cell
            if ((temper1(n41) < ub_temp) .and. (temper1(n41) > lb_temp)) then  !If salinity is within excepted range
                temp_n41 = temper1(n41)                                                  ! Save temperature of n41
                if (temp_n41 < low_temp) then                                       !If temperature in the down-right position is lower than lowest temperature encountered in area
        ...
        if (n_low == n0) then                                                  !If the middle position still has the lowest temperature
