...
contains
    subroutine part21 (lun2, lgrid, lgrid2, xb, yb, &
        ...
        !     formats
        !
        155 format(//6x, 'Warning: from calc. conc. dependent settling velocities')
        160 format(15x, 'Number of particles outside of the plotgrid: ', i8)
        170 format(15x, 'Number of particles at permanent dry points: ', i8)
        180 format(15x, 'Number of particles at temporary dry points: ', i8)
        190 format(15x, 'For all those particles settling velocity was set to zero!'/  &
