...
contains
    subroutine re_orien_sal_temp (n, m, num_rows, num_columns, mnmaxk, &
        ...
        if (temp_n1 < 9999) then                                             !If temperature is within low bound and high bound of sencing
        ...
        if (temp_n12 < 9999) then                                            !If temperature is within low bound and high bound of sencing
        ...
        if (temp_n2 < 9999) then                                             !If temperature is within low bound and high bound of sencing
        ...
        if (temp_n23 < 9999) then                                            !If temperature is within low bound and high bound of sencing
        ...
        if (temp_n3 < 9999) then                                             !If temperature is within low bound and high bound of sencing
        ...
        if (temp_n34 < 9999) then                                            !If temperature is within low bound and high bound of sencing
        ...
        if (temp_n4 < 9999) then                                             !If temperature is within low bound and high bound of sencing
        ...
        if (temp_n41 < 9999) then                                            !If temperature is within low bound and high bound of sencing
