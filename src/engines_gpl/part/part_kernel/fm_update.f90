...
contains
    ...
    subroutine update_part(itime)
        ...
        if (time0>=starttime) then
            ...
            if (timestep<=0d0) then   ! update particles every computational time step
