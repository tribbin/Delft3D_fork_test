...
contains
    ...
    subroutine integration_scheme_13(buffer, file_unit_list, file_name_list, action, dlwqd, gridps)
        ...
        associate (a => buffer%rbuf, j => buffer%ibuf, c => buffer%chbuf)
            ...
            ! add the waste loads
            call dlwq15(num_substances_transported, num_substances_total, nosss, num_exchanges, num_waste_loads, &
            ...
            call dlwqe1(num_substances_transported, num_substances_total, nosss, num_exchanges_z_dir, lnoq, &
