    ...
    subroutine integration_scheme_16(buffer, file_unit_list, file_name_list, action, dlwqd, gridps)
        ...
        associate (a => buffer%rbuf, j => buffer%ibuf, c => buffer%chbuf)
            ...
            do isys = 1, num_substances_transported
                ...
                ! initialize diagonal
                call dlwqf2(num_cells, num_boundary_conditions, idt, a(ivol2:), gm_diag(1, ith))
                ...
                call dlwqf6(num_cells, num_substances_total, isys, 1, gm_sol(1, ith), &
                        a(iconc:), iknmkv)
            ...
            if (forester) then
                call dlwqd2(file_unit_list(19), num_substances_transported, num_substances_total, num_cells, num_exchanges_z_dir, &
