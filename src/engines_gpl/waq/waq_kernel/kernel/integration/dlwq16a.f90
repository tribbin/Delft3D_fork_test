...
contains
    ...
    !! version of dlwq16 for emission module (25) with total flux equal to flow for this substance  (dq = v).
    ...
    subroutine dlwq16a(num_substances_transported, num_substances_total, num_cells, num_exchanges_u_dir, num_exchanges_v_dir, &
