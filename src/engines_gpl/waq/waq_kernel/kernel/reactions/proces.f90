...
module m_proces
    ...
    subroutine proces(num_substances_total, num_cells, conc, volume, itime, &
        ...
        if (bloom_status_ind > 0) then         ! Check presence of BLOOM module for this run
            ...
            if (mod(istep - 1, ndtblo) == 0) then
                ...
                call onepro(bloom_status_ind, bloom_ind, idt, itfact, progrd, &
        ...
        call twopro(num_processes_activated, num_grids, noflux, num_vars, num_cells, &
    ...
    subroutine twopro(num_processes_activated, num_grids, noflux, num_vars, num_cells, &
            num_substances_total, progrd, grdnos, iflux, vgrset, &
            grdseg, volume, deriv, stochi, flux, &
            prondt, ibflag, isdmp, flxdmp, &
            bloom_status_ind, istep)
