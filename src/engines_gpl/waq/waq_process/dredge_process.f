...
!!  rights reserved.
     ...
     +                        noq3   , noq4   )
      ...
      logical, allocatable :: dredge_moment(:) ! indication per basin if the current step is a dredge_process step
...
!     copy sum_dredge (remaining dredge_process mass) from pmsa
