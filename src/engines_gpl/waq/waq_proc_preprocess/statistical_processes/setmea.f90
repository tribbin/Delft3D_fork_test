...
contains
    ...
    SUBROUTINE SETMEA (LUNREP, NOKEY, &
            KEYNAM, KEYVAL, &
            PERNAM, PERSFX, &
            PSTART, PSTOP, &
            IPROC, aProcesProp, &
        ...
        !
        !     FUNCTION            : Sets io list for statistical routine STAMEA
        !
        ...
        if (timon) call timstrt("setmea", ithndl)
        !
        !     init
        !
        ...
        IF (IERR_ALLOC /= 0) THEN
            ...
            WRITE(LUNREP, *) 'in routine SETMEA_3, buffer length:', NOKEY
        ...
        !
        aProcesProp%name = 'STAMEA'
        WRITE(aProcesProp%name(7:10), '(I4.4)') IPROC
        aProcesProp%routine = 'STAMEA'
        aProcesProp%text = 'descriptive statistics, AVG'
