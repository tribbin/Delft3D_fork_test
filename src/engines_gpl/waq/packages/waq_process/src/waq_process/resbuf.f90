...
! dResS2Pup     F pick-up resuspension flux IM1 from S2     (g/m3/d)
      ...
      real(kind=sp)  ::im1s1    
      real(kind=sp)  ::zresim1  
      real(kind=sp)  ::vresim1  
      real(kind=sp)  ::tcrrim1  
      real(kind=sp)  ::im2s1    
      real(kind=sp)  ::zresim2  
      real(kind=sp)  ::vresim2  
      real(kind=sp)  ::tcrrim2  
      real(kind=sp)  ::im3s1    
      real(kind=sp)  ::zresim3  
      real(kind=sp)  ::vresim3  
      real(kind=sp)  ::tcrrim3  
      real(kind=sp)  ::dms1       
      real(kind=sp)  ::dms2     
      ...
      real(kind=sp)  ::frpoms2pup
      real(kind=sp)  ::flrim1s1
      real(kind=sp)  ::flrim2s1
      real(kind=sp)  ::flrim3s1
      real(kind=sp)  ::flrdms1
      real(kind=sp)  ::flrdms2
      ...
      ! new
      real(kind=sp)  ::press1im1, press1im2, press1im3, flres1, tims1
