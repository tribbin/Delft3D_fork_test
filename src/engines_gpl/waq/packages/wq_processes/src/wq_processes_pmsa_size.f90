...
contains
      ...
      integer(kind=int_32), intent(inout) ::  isizea     ! Required array space

      !     Local declarations

      type(memory_partition)               :: part      ! Private variables for MAKPTR
      integer(kind=int_32) :: i_rar                              ! loop counter
      integer(kind=int_32) :: nr_rar                             ! number of real arrays
      ...
      integer(kind=int_32) :: ip_rar(78)                         ! help array to fill the common block / SYSA /
