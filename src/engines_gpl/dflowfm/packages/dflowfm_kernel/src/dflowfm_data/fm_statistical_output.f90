...
contains
   ...
   !! the unit_transport_per_rate is known during model initialisation
   subroutine add_station_sedtrans_configs(output_config_set)
      ...
      call add_output_config(output_config_set, IDX_HIS_SBCX, &
                             ...
                             '', stmpar%morpar%moroutput%unit_transport_per_rate, UNC_LOC_STATION, nc_attributes=atts(1:1), nc_dim_ids=t_station_nc_dimensions(statdim=.true., sedtotdim=.true., timedim=.true.))
