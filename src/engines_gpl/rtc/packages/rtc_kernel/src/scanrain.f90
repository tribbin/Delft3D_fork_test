...
!
      ...
      IF (ENDFIL) then
         CALL ERRMSG2 (911, 0, 'ScanRain', ' Precipitation file', IOUT1)
         RetVal = 911
         Return
      Endif
...
! *********************************************************************
      ...
      DO IEVENT=1,NEVENT
        ...
        CALL SKPCOM (IN, ENDFIL, 'RTC')
        IF (ENDFIL) then
           CALL ERRMSG2 (911, 0, '  ScanRain', STRING, IOUT1)
           RetVal = 911
           Return
        Endif
...
!
  991 CONTINUE
      CALL ERRMSG2 (911, IECODE, 'ScanRain', ' neerslag file', IOUT1)
      RetVal = 911
      Return
  150 CONTINUE
      CALL ERRMSG2 (902, IECODE, 'ScanRain', ' neerslag file', IOUT1)
      RetVal = 902
